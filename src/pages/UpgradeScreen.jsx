          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            <button className="giant-btn" onClick={handleRegister} disabled={isLoading}
              ...
              <span style={{ fontSize: 13, fontWeight: 800, opacity: 0.9 }}>
                {parseFloat(tierCosts[0]).toFixed(3)} BNB <span style={{ fontSize: 11, fontWeight: 900, color: '#ffffff', marginLeft: 4, textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}>≈ ${(parseFloat(tierCosts[0]) * bnbPrice).toFixed(2)} USD</span>
              </span>
            </button>
