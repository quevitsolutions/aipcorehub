          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            <button className="giant-btn" onClick={handleRegister} disabled={isLoading}
              ...
              <span style={{ fontSize: 13, fontWeight: 800, opacity: 0.9 }}>
                {parseFloat(tierCosts[0]).toFixed(3)} BNB <span style={{ fontSize: 11, fontWeight: 950, color: '#000000', marginLeft: 4 }}>≈ ${(parseFloat(tierCosts[0]) * bnbPrice).toFixed(2)} USD</span>
              </span>
            </button>
